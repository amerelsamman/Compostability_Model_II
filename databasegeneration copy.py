...
wvtr, ts, eab, cobb, compost (disintegration + biodegradation)
...
cobb_unit, compost_prediction, compost_unit, compost_day_30, 
compost_day_90, compost_day_180, compost_max, compost_biodegradation_time_profile
"""
...
class PolymerBlendDatabaseGenerator:
    ...
    def _create_blend_input_string(self, materials: List[Tuple[str, str]], 
        ...
        if blend_type == 'equal':
            ...
            import random
            fractions = [random.random() for _ in range(len(materials))]
            total = sum(fractions)
