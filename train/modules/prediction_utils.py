...
PROPERTY_CONFIGS = {
    'wvtr': {
        'name': 'WVTR',
        'unit': 'g/m²/day',
        'model_path': 'train/models/wvtr/v2/comprehensive_polymer_model.pkl',
    ...
    'ts': {
        ...
        'unit': 'MPa',
        'model_path': 'train/models/ts/v2/comprehensive_polymer_model.pkl',
    ...
    'eab': {
        ...
        'unit': '%',
        'model_path': 'train/models/eab/v2/comprehensive_polymer_model.pkl',
        'env_params': ['Thickness (um)'],
        'min_parts': 4,  # 2 polymers (6 parts) + 1 environmental
        'log_scale': True
    },
    'cobb': {
        'name': 'Cobb Value',
        'unit': 'g/m²',
        'model_path': 'train/models/cobb/v1/last1_training/comprehensive_polymer_model.pkl',
        'env_params': [],
    ...
    'seal': {
        ...
        'unit': 'N/15mm',
        'model_path': 'train/models/seal/v2/comprehensive_polymer_model.pkl',  # Updated path
        'env_params': ['Thickness (um)'],
        'min_parts': 4,  # 2 polymers (6 parts) + 1 environmental
        'log_scale': True,
    ...
    'otr': {
        ...
        'unit': 'cc/m²/day',
        'model_path': 'train/models/otr/v2/comprehensive_polymer_model.pkl',
        'env_params': ['Temperature (C)', 'RH (%)', 'Thickness (um)'],
        'min_parts': 6,  # 2 polymers (6 parts) + 3 environmental
        'log_scale': True
    },
