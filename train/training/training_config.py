"""
Training configuration for all polymer blend properties.
This ensures identical functionality while allowing flexibility for future model changes.
"""
...
class PropertyConfig:
    """Configuration for a single property's training"""
    name: str
...
PROPERTY_CONFIGS = {
    'ts': PropertyConfig(
        ...
        oversampling_factor=0,  # 10x oversampling of last 4 blends
        log_offset=0.0,
    ...
    'otr': PropertyConfig(
        ...
        is_dual_property=False,
        default_last_n_training=0,
        default_last_n_testing=0,  # Last 2 in testing
        oversampling_factor=0,  # No oversampling
        log_offset=0.0,
        remove_zero_targets=False,
        handle_nan_targets=True
    ...
    'adhesion': PropertyConfig(
        ...
        is_dual_property=False,
        default_last_n_training=0,
        default_last_n_testing=0,  # Last 5 in testing
        oversampling_factor=0,  # No oversampling
        log_offset=1e-10,
        remove_zero_targets=True,
        handle_nan_targets=False
    ...
    'eab': PropertyConfig(
        ...
        default_last_n_training=0,
        default_last_n_testing=0,
        oversampling_factor=0,  # 2x oversampling of last 4 blends
        log_offset=0.0,
        remove_zero_targets=False,
        handle_nan_targets=False
    ),
    ...
    'eol': PropertyConfig(
        ...
        default_last_n_testing=0,
        oversampling_factor=0,  # 10x oversampling of last 4 blends
        log_offset=1e-6,  # Special offset for max_L
        remove_zero_targets=False,
        handle_nan_targets=False
    )
}
