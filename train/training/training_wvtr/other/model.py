...
parser.add_argument('--output', type=str, default='models/wvtr/v14/last5_training',
                    help='Output directory path (default: models/wvtr/v14/last5_training)')
...
# Combine training indices: remaining training data + last 22 blends
...
print(f"Last 22 blends in training: {all(i in train_indices for i in last_22_indices)}")
